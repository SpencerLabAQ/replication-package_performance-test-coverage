...
#SBATCH -o /NFSHOME/mimran/out/graph-codebert/graph-codebert.out  # Standard output file path
#SBATCH -e /NFSHOME/mimran/out/graph-codebert/graph-codebert.err   # Standard error file path
